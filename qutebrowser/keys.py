...
config.bind('xsa',  'spawn steamdeck-play -a {url}')
config.bind(';xsa', "hint links spawn steamdeck-play -a {hint-url}")
config.bind('xss',  'spawn steamdeck-play {url}')
config.bind(';xss', "hint links spawn steamdeck-play {hint-url}")
